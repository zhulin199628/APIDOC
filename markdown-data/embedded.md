...
## 1. typedef int (*GwConnectCallbackFun)(gboolean ConnectStatus) 222
...
## 6. axa_result_e Axalint(AxaMsgCallbackFunc<br> pMsgCb, GwConnectcallbackFun pGwConnectCb,<br> const char *workDir) update
